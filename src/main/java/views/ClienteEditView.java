...
public class ClienteEditView extends javax.swing.JFrame {
    ...
    private static ClienteEditView clienteEditOrDeleteUnico;

    /**
     * Creates new form ClienteEditOrDelete
     */
    public ClienteEditView() {
        initComponents();
    }

    public static ClienteEditView getClienteEditOrDelete() {
        if (clienteEditOrDeleteUnico == null) {
            clienteEditOrDeleteUnico = new ClienteEditView();
        }
        return clienteEditOrDeleteUnico;
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("EDITAR OU EXCLUIR CLIENTE");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (jTextField1.getText().isEmpty()) {
            ...
            var cliente = dao.getClienteById(id);
            dao.FechaConexao();
            ...
            if (cliente != null) {
                ...
                jTextField4.setText(cliente.getCpf());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (this.selectedCliente != null) {
            ...
            ClienteDAO dao = new ClienteDAO();
            dao.CriaConexao();
            cliente.setId(this.selectedCliente.getId());
            ...
            jTextField5.setText("");
            this.selectedCliente = null;
            JOptionPane.showMessageDialog(null, "Os dados do cliente foram atualizados.", "Sucesso", JOptionPane.INFORMATION_MESSAGE);
        } else {
            JOptionPane.showMessageDialog(null, "Por favor, informe um ID.", "Campo vazio", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (this.selectedCliente != null) {
            ...
            if (resposta == JOptionPane.YES_OPTION) {
                ClienteDAO dao = new ClienteDAO();
                dao.CriaConexao();
                var id = this.selectedCliente.getId();
                var cliente = dao.getClienteById(String.valueOf(id));
